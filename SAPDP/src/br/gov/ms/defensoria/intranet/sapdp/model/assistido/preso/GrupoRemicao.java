 ...
 */
@Entity
@Table(name = "TB_GRUPO_REMICAO")
public class GrupoRemicao {
	...
	private TotalRemicao totalRemicao;
	...
	public TotalRemicao getTotalRemicao() {
		return totalRemicao;
	}


	public void setTotalRemicao(TotalRemicao totalRemicao) {
