...
public class DashboardView implements Serializable {
	...
	public void init() {
		...
		column1.addWidget("assistidosEmEspera");
		column1.addWidget("historicoAssistido");

		column2.addWidget("assistidosAtendidos");
		column2.addWidget("registrarHistorico");
	...
	public void handleReorder(DashboardReorderEvent event) {
		...
		message.setDetail("Item index: " + event.getItemIndex()
				+ ", Coluna index: " + event.getColumnIndex()
				+ ", Enviou p/ index: " + event.getSenderColumnIndex());
