...
/**
 * Esta classe contem um conjunto de metodos amplamente
 * utilizados para manipular componentes do JavaServer Faces.
 */
public class FacesUtil {
    ...
    /**
     * Devolve um array de objetos SelectItem (usados em combos e selects) a partir de uma lista de objetos de entidades. Obs: para o perfeito funcionamento deste método é nencessário que as classes
     * de entidades implementem o metodo toString corretamente.
     *
     * @author <a href="mailto:dayani.oliveira@sensedia.com.br">Dayani de Oliveira</a>
     * @param entities Lista de objetos de entidades.
     * @param selectOne Habilita ou nao que o primeiro elemento da combo seja vazio.
     ...
     * @param key de bundle da mensagem.
     */
     ...
     * @param clientId O client id do componente.
     * @param key de bundle da mensagem.
     */
    ...
    public static void addErrorMessage(String clientId, String key, Object... params) {
        String keyvalue = "";//ResourceBundleUtil.getKey(getLocale(), key, params);
    ...
    /**
     * Recupera a localidade da aplicacao, ou seja, se atualmente estah
     * sendo utilizada a lingua portugues, ingles ou espanhol, por exemplo.
     ...
     * @param varName Nome do managed-bean SEM as marcas da expressao EL #{}.
     ...
     * @param varName Nome do managed bean SEM as marcacoes da expressao EL #{}.
     * @param newValue Objeto que sera setado no managed-bean
     */
    ...
    /**
     * Limpa todos os valores preenchido nos campos da view corrente (formulario corrente).
     */
     ...
     * @param varName Nome do managed bean SEM as marcacoes da expressao EL #{}
     * @param retorno Classe do managed bean
    ...
    /**
     * Metodo responsavel pela internacionalizacao de uma key passa como parametro. Este metodo utiliza tambem a classe utilitaria de message RsourceBundleUtil
     *
     * @author lpache
     * @param key
     * @return valor I18n
    ...
    public static String getMessageByKey(String key) {
        try {
            return "";//ResourceBundleUtil.getKeyBundle(FacesUtil.getLocale(), "ApplicationMessages", key);
        } catch (Exception e) {
            return key;
        }
    }
    ...
    /**
     * Cria uma lista de selectItens onde o value = valor do enum, e o label = valor I18n do enum
     *
     * @author lpache
     * @param Classe Enumerated
     */
     ...
     * @param fieldLabel = O atributo dos beans que serao exibidos no label do selectItem
     ...
     * @param lista = Uma lista de beans qualquer.
     * @param fieldLabel = O atributo dos beans que serao exibidos no label do selectItem
     * @param separator = O caracter de separacao entre os atributos exibidos, exemplos: ' - ' ou ' : ' ou ' / '
     *
     * @return Retorna uma lista de SelectItem para ser usado em paginas JSF
     */
    ...
    /**
     * Este metodo recebe uma classe de enum e um valor key e retorna o valor I18n.
     * @param clazz
     * @param key
     * @return
     */
    ...
    /**
     * Este metodo recebe uma classe de enum e um valor I18n e retorna o enum correspondente.
     * Funciona ao contrario do metodo internacionalize Enum.
